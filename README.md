...
The compiler parses the MiniKotlin program into an Abstract Syntax Tree (AST), performs semantic analysis, and generates resulting Java Continuation-Passing-Style code. 
...
Logical operators (&& and ||) correctly short-circuit. Instead of evaluating both sides and passing them to a boolean operation, the compiler generates a continuation branch after evaluating the left side.
